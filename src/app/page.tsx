    ...
    <main className="min-h-screen bg-gradient-to-tr from-blue-50 to-white text-gray-800">
      ...
      <section className="text-center px-4 sm:px-6 pt-20 pb-16">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-3xl sm:text-5xl font-bold mb-4">🌍 Welcome to World View App</h1>
          <p className="text-base sm:text-xl max-w-2xl mx-auto text-gray-700 mb-6">
            Discover the world’s countries, cultures, flags, and facts — all in one place.
            Built for everyone, everywhere.
          </p>
          <Link
            href="/explore"
            className="inline-block bg-blue-600 text-white px-6 py-3 rounded-lg text-base sm:text-lg font-medium hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-400 transition"
          >
            Start Exploring
          </Link>
        </div>
      ...
      <section className="bg-white py-16 px-4 sm:px-6" aria-labelledby="features-heading">
      ...
      <section className="bg-blue-50 px-4 sm:px-6 pt-12 pb-12 text-center">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-2xl sm:text-3xl font-semibold mb-4">Why World View?</h2>
